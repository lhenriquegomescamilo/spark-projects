...
val nDays = 30
val users = get_safegraph_data(spark,nDays.toString,"31","argentina")
...
.saveAsTextFile("/datascience/geo/geospark_debugging/sample_w_rdd_%s_points_first_RDD_partII".format(nDays.toString))
