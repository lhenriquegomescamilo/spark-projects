...
.map( row=> List(row._2.device.brand.getOrElse("")
  row._1,row._2.device.model.getOrElse(""),row._2.userAgent.family,row._2.os.family,row._2.os.major.getOrElse(""),row._2.os.minor.getOrElse("")).mkString(",") )
