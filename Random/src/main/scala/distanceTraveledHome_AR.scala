...
val raw = get_safegraph_data(spark,"10","0",country)
.withColumnRenamed("ad_id","device_id")
...
val output_file = "/datascience/geo/Reports/GCBA/Coronavirus/%s_10D/geohashes_by_user_%s".format(today,country)
...
.format("csv")
.option("header",true)
.save("/datascience/geo/Reports/GCBA/Coronavirus/%s_10D/geohashes_by_country_%s".format(today,country))
...
//Acá por provincia
val output_file_provincia = "/datascience/geo/Reports/GCBA/Coronavirus/%s_10D/geohashes_by_provincia_%s".format(today,country)
...
//Acá por partido
val output_file_partido = "/datascience/geo/Reports/GCBA/Coronavirus/%s_10D/geohashes_by_partido_%s".format(today,country)
...
val output_file_tipo_1 = "/datascience/geo/Reports/GCBA/Coronavirus/%s_10D/geohash_travel_barrio_CLASE1_%s".format(today,country)
...
//Alternativa 2
val output_file_tipo_2 = "/datascience/geo/Reports/GCBA/Coronavirus/%s_10D/geohash_travel_barrio_CLASE2_%s".format(today,country)
