...
//    println("Devices Nid:")
 //   println(detergentes_nid.join(nids,Seq("nid_sh2"),"inner").select("nid_sh2").distinct().count())
  ...
  def reprocess_dumps(spark:SparkSession){
    val files = List("2020-01-30_daily","2020-01-31_daily","2020-02-01_daily","2020-02-02_daily","2020-02-03_daily","2020-02-04_daily","2020-02-05_daily","2020-02-06_daily","2020-02-07_daily","2020-02-08_daily",
