...
.option("header",true)
.option("delimiter","\t")
.save("/datascience/geo/Reports/JCDecaux/cluster_time_count_13_02_2020")
...
.option("header",true)
.option("delimiter","\t")
.save("/datascience/geo/Reports/JCDecaux/all_day_long_count_13_02_2020")
...
.option("header",true)
.option("delimiter","\t")
.save("/datascience/geo/Reports/JCDecaux/total_time_count_13_02_2020")
...
.option("header",true)
.option("delimiter","\t")
.save("/datascience/geo/Reports/JCDecaux/all_day_total_time_count_13_02_2020")
