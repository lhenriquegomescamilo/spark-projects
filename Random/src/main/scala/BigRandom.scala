...
def getReport(
 ...
 /*****************************************************/
  ...
  def main(args: Array[String]) {
    ...
    .option("delimiter","\t")
    .option("header",false)
    .load("/datascience/keywiser/test_stem/AR_scrapper_test_15Dsince27_IM_stemmed_2020-02-17T15-26-35-997299")
    ...
    .option("delimiter","\t")
    .option("header",false)
    .load("/datascience/keywiser/test_stem/AR_scrapper_test_15Dsince1_IM_stemmed_2020-02-17T15-26-27-685890")
    .withColumnRenamed("_c1", "device_id")
    .withColumnRenamed("_c2", "segment_id")
    .groupBy("segment_id")
    .agg(
